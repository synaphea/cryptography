...
class MorseCipher {
    constructor() {
        this.CODE_VALS = Object.keys(MorseCipher.MORSE_CODES).map(key => MorseCipher.MORSE_CODES[key]);
...
exports.MorseCipher = MorseCipher;
exports.default = MorseCipher;
